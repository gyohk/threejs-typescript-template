...
module app {
    ...
    export class MorphModelMain {
        private renderer:THREE.WebGLRenderer;
        private scene:THREE.Scene;
        private camera:THREE.PerspectiveCamera;

        private animmesh: THREE.MorphAnimMesh;
        ...
        public render():void {
            ...
            if (this.animmesh) {
                this.animmesh.updateAnimation(delta);
            }
        ...
        private loadModel():void {
            ...
            loader.load("./assets/models/exported/unhappy-monkey-2.js",
                (model: THREE.Geometry, loadedMat: THREE.Material[]) => {
                    var mat = new THREE.MeshNormalMaterial({color: 0xff0000});
                    mat.morphTargets = true;

                    this.animmesh = new THREE.MorphAnimMesh(model, mat);

                    this.animmesh.parseAnimations();
                    console.log(this.animmesh);

                    this.animmesh.playAnimation("animation", 30);
